package com.team1.myworkout.util;

/**
 * Created by hush on 2017/12/2.
 */
...
public class AssetsDatabaseManager {
    ...
    private static String databasepath = "/data/data/com.team1.myworkout/database"; // %s is packageName
